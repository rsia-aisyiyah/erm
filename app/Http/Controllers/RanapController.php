...
class RanapController extends Controller
{
    ...
    public function ranap(Request $request)
    {
        ...
        $ranap = KamarInap::with(['regPeriksa.pasien', 'regPeriksa.dokter', 'regPeriksa.dokter.spesialis', 'kamar', 'ranapGabung.regPeriksa.dokter', 'ranapGabung.regPeriksa.pasien', 'kamar.bangsal', 'regPeriksa.penjab', 'regPeriksa.kamarInap','regPeriksa.asmedRanapKandungan','regPeriksa.asmedRanapAnak'])->orderBy('no_rawat', 'DESC');
