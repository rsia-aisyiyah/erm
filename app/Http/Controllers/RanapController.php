...
class RanapController extends Controller
{
    ...
    public function ranap(Request $request)
    {
        ...
        $ranap = KamarInap::with(['regPeriksa.pasien', 'regPeriksa.dokter', 'regPeriksa.dokter.spesialis', 'kamar', 'ranapGabung', 'ranapGabung.regPeriksa.pasien', 'kamar.bangsal', 'regPeriksa.penjab'])->orderBy('no_rawat', 'DESC');
