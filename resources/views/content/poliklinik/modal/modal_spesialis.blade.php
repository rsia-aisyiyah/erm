<div class="modal fade" id="modalSpesialis" tabindex="-1" aria-labelledby="modalSpesialis" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-md">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-stripped table-spesialis text-sm">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Kode Poli</th>
