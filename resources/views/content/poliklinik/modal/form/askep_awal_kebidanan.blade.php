                ...
                <div class="card-body">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                <x-input-radio id="alat_bantu_tidak" name="alat_bantu" value="Tidak" label="Tidak"
                                    checked />
                        ...
                        <div class="col-md-2">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                <x-input-radio id="prothesa_tidak" name="prothesa" value="Tidak" label="Tidak"
                                    checked />
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                <x-input-radio id="lapor_ya" name="lapor" value="Ya" label="Ya" checked />
                                <x-input-radio id="lapor_tidak" name="lapor" value="Tidak" label="Tidak" />
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <x-input-group class="input-group-sm">
                                <x-input name="ket_lapor" type="time" />
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                ...
                                <x-input-radio data-nilai="0" id="sg2_tidak" name="sg2" value="Tidak" label="Tidak"
                                    checked />
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="row g-2">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                <x-input-radio id="menyebar_tidak" name="menyebar" value="Tidak" label="Tidak"
                                    checked />
                        ...
                        <div class="col-md-12 p-3">
                            ...
                            <input type="range" class="form-range m-0" min="0" max="10" step="1" id="skala_nyeri"
                                name="skala_nyeri" value="0">
                        </div>
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="d-flex gap-3 mt-2">
                                ...
                                <x-input-radio name="pada_dokter" id="pada_dokter_tidak" label="Tidak" value="Tidak"
                                    checked />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <label for="ket_dokter">Jam </label>
                            <x-input type="time" name="ket_dokter" />
                        </div>
