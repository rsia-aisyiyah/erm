                                ...
                                <div class="row">
                                    ...
                                    <div class="mb-2 col-sm-12 col-md-6 col-lg-5">
                                        <div class="input-group">
                                            ...
                                            <input type="search" class="form-control form-control-sm hubungan" placeholder="" aria-label="" id="hubungan" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" style="margin-left: 10px;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="mb-3 col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                                    ...
                                    <input type="text" class="form-control form-control-sm" id="gcs" name="gcs" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-3">
                                    <label for="tb">TB (cm)</label>
                                    <input type="text" class="form-control form-control-sm" id="tb" name="tb" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-2">
                                    <label for="bb">BB (Kg)</label>
                                    <input type="text" class="form-control form-control-sm" id="bb" name="bb" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-2">
                                    <label for="td">TD (mmHg)</label>
                                    <input type="text" class="form-control form-control-sm" id="td" name="td" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-2">
                                    <label for="nadi">Nadi (x/menit)</label>
                                    <input type="text" class="form-control form-control-sm" id="nadi" name="nadi" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-2">
                                    <label for="rr">RR (x/menit)</label>
                                    <input type="text" class="form-control form-control-sm" id="rr" name="rr" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-2">
                                    <label for="suhu">Suhu (<sup>0</sup>C)</label>
                                    <input type="text" class="form-control form-control-sm" id="suhu" name="suhu" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-3 col-sm-12 col-md-4 col-lg-2">
                                    <label for="spo2">SpO2(%)</label>
                                    <input type="text" class="form-control form-control-sm" id="spo" name="spo2" placeholder="" maxlength="10" style="font-size:11px;min-height:20px;border-radius:0;" onfocus="removeZero(this)" onblur="cekKosong(this)" value="-" autocomplete="off">
                                </div>
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    <label for="">Kepala :</label>
                                    <select class="form-select" name="kepala" id="kepala" style="font-size:11px;min-height:20px;border-radius:0;">
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="mata" id="mata" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="gigi" id="gigi" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    <label for="">THT :</label>
                                    <select class="form-select" name="tht" id="tht" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="thorax" id="thorax" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="jantung" id="jantung" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="paru" id="paru" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="abdomen" id="abdomen" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="genital" id="genital" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="ekstremitas" id="ekstremitas" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="mb-1 col-sm-12 col-md-4 col-lg-6">
                                    ...
                                    <select class="form-select" name="kulit" id="kulit" style="font-size:11px;min-height:20px;border-radius:0;">
                                        <option value="Normal">Normal</option>
                                        <option value="Abnormal">Abnormal</option>
                                        <option value="Tidak Diperiksa">Tidak Diperiksa</option>
                                    </select>
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-6">
                                    ...
                                    <textarea class="form-control" name="ket_fisik" id="ket_fisik" cols="30" rows="5" style="font-size:11px;min-height:20px;border-radius:0;resize:none" onfocus="removeZero(this)" onblur="cekKosong(this)">-</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-12 col-md-12 col-lg-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-4">
                                    ...
                                    <textarea class="form-control" name="edukasi" id="edukasi" cols="30" rows="8"
                                        style="font-size:11px;min-height:20px;border-radius:0;resize:none" onfocus="removeZero(this)"
                                        onblur="cekKosong(this)">-</textarea>
                                </div>
                            </div>
