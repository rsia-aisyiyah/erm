...
@section('content')
        ...
        left: 0;
        right: 0;
        bottom: 10mm;   /* sesuaikan dengan margin bawah */
        height: 25mm;
        border-top: 1px solid #000;
        font-size: 9px;
    }
                                        ...
                                        <div class="content-box">
                                            ...
                                            <ol>
                                                ...
                                                <li>
                                                    ...
                                                    Saya memberikan persetujuan kepada RSIA Aisyiyah Pekajangan beserta dokter,
                                                    perawat dan tenaga kesehatan lainnya untuk melakukan pemeriksaan,
                                                    tindakan medis, laboratorium, radiologi, terapi maupun pelayanan lain
                                                ...
                                                <li>
                                                    ...
                                                    Saya memahami rumah sakit tidak bertanggung jawab atas kehilangan barang
                                                    yang tidak dititipkan.
                                                </li>

                                                <li>
                                                    <strong>FASILITAS RUMAH SAKIT.</strong>
                                                    Saya bertanggung jawab atas kerusakan fasilitas rumah sakit yang saya sebabkan.
                                                </li>
               ...
               <table width="100%" style="font-size:10px">
                ...
                <tr>
                    ...
                    <td width="20%" align="right">
                        <img src="data:image/png;base64,{{ DNS2D::getBarcodePNG($verifyUrl, 'QRCODE') }}" width="60" height="60">
                        <br>
