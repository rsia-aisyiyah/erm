        ...
        <thead>
            <tr>
                <th colspan="6" style="background-color:rgb(227, 255, 162);font-size:12px">
                    ASESMEN AWAL MEDIS RAWAT JALAN KEBIDANAN DAN KANDUNGAN
                </th>
            </tr>
        </thead>
        <tbody>
            ...
            <tr>
                <td style="font-size:10px; height:180x" colspan="3">
            ...
            <tr>
                <td colspan="6" style="text-align: center;background-color:#e7e7e7 ">
                    <p><strong>3. STATUS OBSTETRI & GINEKOLOGI</strong></p>
                </td>
            </tr>
            <tr>
                <td style="font-size:10px; text-align:center" colspan="6">
                    TFU : {{ $data['tfu'] }} Cm,
                    TBJ : {{ $data['tbj'] }} gram,
                    HIS : {{ $data['tbj'] }} x/10 Menit,
                    Kontraksi : {{ $data['kontraksi'] }},
                    DJJ : {{ $data['djj'] }} Dpm,
                </td>
            </tr>
            <tr>
                <td style="font-size:10px;vertical-align:top;height:30px" colspan="3" class="border">
            ...
            <tr>
                <td style="font-size:10px;vertical-align:top;height:30px" colspan="2" class="border">
                    Ultrasonografi : <br>
                    {{ $data['ultra'] }}
                </td>
                <td style="font-size:10px;vertical-align:top;height:30px" colspan="2" class="border">
            ...
            <tr>
                <td style="font-size:10px;vertical-align:top;height:20px" colspan="6" class="border">
