                ...
                <form action="" id="formDischargePlanning">
                    ...
                    <div class="row gy-2 sectionMonitoring">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            ...
                            <textarea id="target_asuhan" name="target_asuhan" class="form-control form-control-sm" rows="5" style="min-height: 120px;" placeholder="Target Asuhan yang terukur">-</textarea>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <label for="diet_dirumah" class="form-label">Diet Dirumah</label>
                            <textarea id="diet_dirumah" name="diet_dirumah" class="form-control form-control-sm" rows="5" style="min-height: 120px;" placeholder="Diet di rumah">-</textarea>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-12">
                            <label for="instruksi" class="form-label">Instruksi Tindak Lanjut</label>
                            <textarea id="instruksi" name="instruksi" class="form-control form-control-sm" rows="5" style="min-height: 120px;" placeholder="Instruksi tindak lanjut">-</textarea>
                            @csrf
                        </div>
