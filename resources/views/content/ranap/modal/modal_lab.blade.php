<div class="modal fade" id="modalLabRanap" tabindex="-1" aria-labelledby="#modalLabRanapLabel" aria-hidden="true"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row mb-2 gy-2" id="formInfoPasienPenunjang">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                        <label for="dokter_dpjp">Dokter Perujuk</label>
                ...
                <ul class="nav nav-tabs" id="tabPenunjangRanap" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="laborat-tab" data-bs-toggle="tab"
                            data-bs-target="#laborat-tab-pane" type="button" role="tab" aria-controls="laborat-tab-pane"
                            aria-selected="true">Laboratorium</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="permintaan-laborat-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="permintaan-laborat-tab-pane" aria-selected="true">Permintaan Lab</button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="radiologi-tab" data-bs-toggle="tab"
                            data-bs-target="#radiologi-tab-pane" type="button" role="tab"
                            aria-controls="radiologi-tab-pane" aria-selected="false">Radiologi</button>
                    </li>
                    <li class="nav-item" role="presentation">
                ...
                <div class="tab-content p-2" id="myTabContent" style="height: 70vh">
                    <div class="tab-pane fade h-full show active" id="laborat-tab-pane" role="tabpanel"
                        aria-labelledby="laborat-tab" tabindex="0">

                        <ul class="nav nav-tabs" id="navPeriksaLaborat" role="tablist">
                            <li class="nav-item" role="presentation">
                                <button class="nav-link active" id="tabLabPK" data-bs-toggle="tab"
                                    data-bs-target="#paneLabPK" type="button" role="tab" aria-controls="paneLabPK"
                                    aria-selected="true">Patologi Klinik</button>
                            </li>
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="tabLabPA" data-bs-toggle="tab" data-bs-target="#paneLabPA"
                                    type="button" role="tab" aria-controls="paneLabPA" aria-selected="true">Patologi
                                    Anatomi</button>
                            </li>
                        </ul>
                        <div class="tab-content p-2" id="tabPeriksaLaborat">
                            <div class="tab-pane fade h-full show active" id="paneLabPK" role="tabpanel"
                                aria-labelledby="tabLabPK" tabindex="0">
                                <div class="row gy-2">
                            ...
                            <div class="tab-pane fade h-full" id="paneLabPA" role="tabpanel" aria-labelledby="tabLabPA"
                                tabindex="0">
                                Patologi anatomi
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade h-100" id="permintaan-laborat-tab-pane" role="tabpanel"
                        aria-labelledby="permintaan-laborat-tab" tabindex="0">
                        @include('content.ranap.modal.penunjang.permintaan_lab')
                    </div>
                    <div class="tab-pane fade h-100" id="radiologi-tab-pane" role="tabpanel"
                    ...
                    <div class="tab-pane fade h-100" id="permintaan-radiologi-tab-pane" role="tabpanel"
