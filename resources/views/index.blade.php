...
<body>
    ...
    <script type="text/javascript">
        ...
        function renderListsAsesmenNyeri(tgl_lahir, tgl_daftar, no_rawat) {
            ...
            let list = '';
            if (totalHari <= 28) {
                list = `<li><a class="dropdown-item" href="javascript:void(0)" onclick="showModalAsesmenNyeriNeonatus('${no_rawat}')"><i class="bi bi-emoji-expressionless text-danger me-1"></i> Asesmen Nyeri Neonatus</a></li>`;
            } else if (totalHari <= 3 * 365) {
                // Batita
                list = `<li><a class="dropdown-item" href="javascript:void(0)" onclick="showModalAsesmenNyeriBatita('${no_rawat}')"><i class="bi bi-emoji-smile text-warning me-1"></i> Asesmen Nyeri Anak</a></li>`;
            } else if (totalHari <= 7 * 365) {
                // Balita
                list = `<li><a class="dropdown-item" href="javascript:void(0)" onclick="showModalAsesmenNyeriBalita('${no_rawat}')"><i class="bi bi-emoji-smile text-warning me-1"></i> Asesmen Nyeri Anak</a></li>`;
            } else if (totalHari <= 13 * 365) {
                // Anak
                list = `<li><a class="dropdown-item" href="javascript:void(0)" onclick="showModalAsesmenNyeriAnak('${no_rawat}')"><i class="bi bi-emoji-smile text-warning me-1"></i> Asesmen Nyeri Anak</a></li>`;
            } else {
                // Dewasa
                list = `<li><a class="dropdown-item" href="javascript:void(0)" onclick="showModalAsesmenNyeriDewasa('${no_rawat}')"><i class="bi bi-emoji-frown text-warning me-1"></i> Asesmen Nyeri Dewasa</a></li>`;
            }
